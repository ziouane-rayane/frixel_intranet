defmodule FrixelIntranet.ChatTest do
  ...
  describe "intranet_conversations" do
    ...
    test "list_intranet_conversations/0 returns all intranet_conversations" do
      ...
      assert Chat.list_intranet_conversations() == [intranet_conversation]
    end

    test "get_intranet_conversation!/1 returns the intranet_conversation with given id" do
      intranet_conversation = intranet_conversation_fixture()
      assert Chat.get_intranet_conversation!(intranet_conversation.id) == intranet_conversation
    end
    ...
    test "create_intranet_conversation/1 with valid data creates a intranet_conversation" do
      ...
      assert {:ok, %IntranetConversation{} = intranet_conversation} = Chat.create_intranet_conversation(valid_attrs)
    ...
    test "create_intranet_conversation/1 with invalid data returns error changeset" do
      assert {:error, %Ecto.Changeset{}} = Chat.create_intranet_conversation(@invalid_attrs)
    end
    ...
    test "update_intranet_conversation/2 with valid data updates the intranet_conversation" do
      ...
      assert {:ok, %IntranetConversation{} = intranet_conversation} = Chat.update_intranet_conversation(intranet_conversation, update_attrs)
    ...
    test "update_intranet_conversation/2 with invalid data returns error changeset" do
      intranet_conversation = intranet_conversation_fixture()
      assert {:error, %Ecto.Changeset{}} = Chat.update_intranet_conversation(intranet_conversation, @invalid_attrs)
      assert intranet_conversation == Chat.get_intranet_conversation!(intranet_conversation.id)
    end

    test "delete_intranet_conversation/1 deletes the intranet_conversation" do
      intranet_conversation = intranet_conversation_fixture()
      assert {:ok, %IntranetConversation{}} = Chat.delete_intranet_conversation(intranet_conversation)
      assert_raise Ecto.NoResultsError, fn -> Chat.get_intranet_conversation!(intranet_conversation.id) end
    end

    test "change_intranet_conversation/1 returns a intranet_conversation changeset" do
      intranet_conversation = intranet_conversation_fixture()
      assert %Ecto.Changeset{} = Chat.change_intranet_conversation(intranet_conversation)
    end
  end
  ...
  describe "intranet_messages" do
    ...
    test "list_intranet_messages/0 returns all intranet_messages" do
      ...
      assert Chat.list_intranet_messages() == [intranet_message]
    end

    test "get_intranet_message!/1 returns the intranet_message with given id" do
      intranet_message = intranet_message_fixture()
      assert Chat.get_intranet_message!(intranet_message.id) == intranet_message
    end

    test "create_intranet_message/1 with valid data creates a intranet_message" do
      valid_attrs = %{message_body: "some message_body"}

      assert {:ok, %IntranetMessage{} = intranet_message} = Chat.create_intranet_message(valid_attrs)
    ...
    test "create_intranet_message/1 with invalid data returns error changeset" do
      assert {:error, %Ecto.Changeset{}} = Chat.create_intranet_message(@invalid_attrs)
    end
    ...
    test "update_intranet_message/2 with valid data updates the intranet_message" do
      ...
      assert {:ok, %IntranetMessage{} = intranet_message} = Chat.update_intranet_message(intranet_message, update_attrs)
    ...
    test "update_intranet_message/2 with invalid data returns error changeset" do
      intranet_message = intranet_message_fixture()
      assert {:error, %Ecto.Changeset{}} = Chat.update_intranet_message(intranet_message, @invalid_attrs)
      assert intranet_message == Chat.get_intranet_message!(intranet_message.id)
    end

    test "delete_intranet_message/1 deletes the intranet_message" do
      intranet_message = intranet_message_fixture()
      assert {:ok, %IntranetMessage{}} = Chat.delete_intranet_message(intranet_message)
      assert_raise Ecto.NoResultsError, fn -> Chat.get_intranet_message!(intranet_message.id) end
    end

    test "change_intranet_message/1 returns a intranet_message changeset" do
      intranet_message = intranet_message_fixture()
      assert %Ecto.Changeset{} = Chat.change_intranet_message(intranet_message)
    end
  end
end
