...
config :frixel_intranet, FrixelIntranetWeb.Endpoint,
  ...
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:frixel_intranet, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:frixel_intranet, ~w(--watch)]}
  ]
...
config :frixel_intranet, FrixelIntranetWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/frixel_intranet_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :frixel_intranet, dev_routes: true
